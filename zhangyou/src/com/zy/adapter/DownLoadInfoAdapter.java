...
public class DownLoadInfoAdapter extends BaseAdapter{
	...
	public DownLoadInfoAdapter(Context context,ImageLoader imageLoader) {
		super();
		this.context = context;
		this.imageLoader = imageLoader;
		inflater = ((Activity)context).getLayoutInflater();
	}
	public void setDatas(ArrayList<DownLoadInfo> datas){
		this.datas = datas;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		if(null == convertView){
			 convertView = (ViewGroup) inflater.inflate(R.layout.item_download_lnfo, null);
		...
		DownLoadInfo gameInfo = datas.get(position);
